export default {
    ...
    canvas: {
        ...
        zoom: "Zoom canvas",
        agentConnected: "Creative Director connected",
        agentConnecting: "Creative Director · {{activity}}",
        agentDisconnected: "Creative Director disconnected",
        connecting: "Connecting",
        openAgent: "Open Creative Director panel",
        ...
        nodeToolbar: { favorite: "Favorite", unfavorite: "Remove favorite", noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
    ...
    agent: {
        ...
        panel: { title: "Creative Director", connectionSettings: "Connection settings · {{status}}", connectionSettingsLabel: "Connection settings. Current status: {{status}}", chat: "Chat", history: "History", skills: "Skills", logs: "Logs", collapse: "Collapse chat", collapseLabel: "Collapse Creative Director panel", resize: "Resize right panel", content: "Creative Director content", mcpInitializing: "MCP is initializing. You can send messages when it is ready.", initFailed: "Codex conversation initialization failed. Start or resume a conversation.", placeholder: "Ask the Creative Director, type / for Skills, or @ to reference canvas assets" },
