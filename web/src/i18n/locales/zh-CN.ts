export default {
    ...
    canvas: {
        ...
        resetView: "重置视图",
        zoom: "放大/缩小画布",
        agentConnected: "创意总监已连接",
        agentConnecting: "创意总监 · {{activity}}",
        agentDisconnected: "创意总监未连接",
        connecting: "连接中",
        openAgent: "打开创意总监面板",
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "提示词库", favorites: "收藏", jobs: "任务", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
    ...
    agent: {
        ...
        panel: { title: "创意总监", connectionSettings: "连接设置 · {{status}}", connectionSettingsLabel: "连接设置，当前{{status}}", chat: "对话", history: "历史", skills: "技能", logs: "日志", collapse: "收起对话", collapseLabel: "收起创意总监面板", resize: "调整右侧面板宽度", content: "创意总监内容", mcpInitializing: "MCP 初始化中，完成后即可发送", initFailed: "Codex 对话初始化失败，请新建或恢复对话", placeholder: "向创意总监提问，输入 / 使用技能，@ 引用画布素材" },
